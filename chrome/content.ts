...
function setIntersection(setA:string[], setB:string[]) {
  return new Set([...setA].filter(element => setB.includes(element)));
}

function setUnion(setA:string[], setB:string[]) {
  return new Set([...setA, ...setB]);
}
const page_keywords_set=new Set(page_keywords)
const task_keywords_set=new Set(task_keywords)
const intersection_of_keywords=setIntersection(page_keywords,task_keywords)
const union_of_keywords=setUnion(page_keywords,task_keywords)
